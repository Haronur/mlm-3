...
<div class="center-vertical">
  <div class="center-content row">
    <form onsubmit="return false;" http-type="post" data-url="{{ route('admin.postLogin') }}" id="login-validation" class="action-form col-md-4 col-sm-5 col-xs-11 col-lg-3 center-margin">
      <h3 class="text-center pad25B font-gray text-transform-upr font-size-23"><span class="opacity-80">Admin Area</span></h3>
