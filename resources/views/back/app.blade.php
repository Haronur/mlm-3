...
<html lang="en" prefix="og:http://ogp.me/ns#">
  <head>
    ...
    <link href="//fonts.googleapis.com/css?family=Open+Sans|Raleway" rel="stylesheet">
    <link rel="stylesheet" type="text/css" media="screen" title="style (screen)" href="{{ asset('assets/css/back/plugins.css?v='.filemtime(public_path().'/assets/css/back/plugins.css')) }}" />
    <link rel="stylesheet" type="text/css" media="screen" title="style (screen)" href="{{ asset('assets/css/back/theme.css?v='.filemtime(public_path().'/assets/css/back/theme.css')) }}" />
    ...
    <script type="text/javascript">
      ...
      App.Scripts = {
        ...
        bundle_dep: [
          ...
          window._root + '/assets/js/back/theme.js?v=' + {{ filemtime(public_path().'/assets/js/back/theme.js') }},
        ],
        bundle: [
          window._root + '/assets/js/back/index.js?v=' + {{ filemtime(public_path().'/assets/js/back/index.js') }}
        ]
      };
  ...
  <body>
    ...
    <div id="pageLoader">
      <span class="icon-spin icon-spin-5"></span>
    </div>
