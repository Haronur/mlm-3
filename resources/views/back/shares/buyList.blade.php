      ...
      <div id="page-content">
        <div class="container">
          <div class="page-title">
            <h2>Buy Shares Statement</h2>
          </div>

          <div class="panel">
            <div class="panel-body">
              <div class="example-box-wrapper">
                <table class="table table-full table-full-small dt-responsive display nowrap table-grid" cellspacing="0" width="100%" id="sharesBuyListTable" role="grid" data-url="{{ route('admin.shares.buyList') }}">
                  <thead>
                    <tr>
